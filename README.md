...
**AAF** расшифровывается как **Adaptive Associative Framework**. Название
описывает исходный замысел: система должна была адаптироваться после оценённого
опыта, связывать знания и поведение через ассоциированные специализированные
компоненты и работать как дополнительный программный каркас, а не как одна
самостоятельная нейросеть. `vsLLM` обозначало проверку этой архитектуры рядом с
базовой языковой моделью, а не соревнование двух готовых продуктов.
